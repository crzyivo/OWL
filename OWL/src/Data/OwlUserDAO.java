...
public class OwlUserDAO {
	...
	public void insertarUsuario(OwlUserVO usuario, JDBCTemplate jdbctemp) {
		...
		try {
			...
			// jdbctemp.prepareStatement(queryString);
			// jdbctemp.
			 ...
			 * preparedStatement.setString(11, usuario.getPassword()); int
	...
	public void actualizarUsuario(OwlUserVO usuario, JDBCTemplate jdbctemp) {
		try {
			 ...
			 * 
			 * // Fill "preparedStatement". preparedStatement.setString(1,
			 * usuario.getNombre()); preparedStatement.setString(2,
			 * usuario.getApellidos()); Boolean esMujer = usuario.getSexo();
			 * String sexo = null; if (esMujer != null){ if
			 * (esMujer.booleanValue()){ sexo="M"; }else{ sexo="V"; } }
	...
	public void borrarUsuario(String usuario, JDBCTemplate jdbctemp) {
		...
		try {
			/* Create "preparedStatement". */
			String queryString = "DELETE FROM usuario " + "WHERE email = " + "'" + usuario + "'";
